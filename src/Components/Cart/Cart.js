    ...
    return (
        <div className='sticky'>
            ...
            <div className='bg-amber-400 p-4 rounded-md shadow-red-600 shadow-lg my-5'>
                <h1 className='text-2xl text-green-500 text_center border rounded-lg py-1 border-red-500'>Summary</h1>
            ...
            <div className='bg-amber-400 p-4 rounded-md shadow-red-600 shadow-lg my-5'>
                <h1 className='text-2xl text-green-500 text_center border rounded-lg py-1 border-red-500'>Orders</h1>
